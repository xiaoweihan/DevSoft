...
[Run]
Filename: "{tmp}\vcredist_x86.exe"; Parameters: /q; WorkingDir: {tmp}; Flags: skipifdoesntexist; StatusMsg: "Installing Microsoft Visual C++ Runtime ..."; 
Filename: "{app}\driver\CP210xVCPInstaller_x86.exe";  WorkingDir: "{app}\driver"; Flags: skipifdoesntexist; StatusMsg: "正在安装驱动..."
